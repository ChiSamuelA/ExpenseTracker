...
const AuthLayout = ({ children }) => {
  return (
    <div className='flex'>
        ...
        <div className="hidden md:block w-[48vw] h-screen bg-blue-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
            <div className='w-48 h-48 rounded-[40px] bg-blue-600 absolute -top-7 -left-5' />
            <div className='w-48 h-56 rounded-[40px] border-[20px] border-blue-600 absolute top[38%] -right-10' />
